...
//
//	go build -ldflags "-X github.com/chinmay28/bip39-explorer/server/internal/version.Patch=$(git rev-list --count HEAD)"
//
...
// what /healthz reports, and what the PWA shows in its header.
func String() string {
